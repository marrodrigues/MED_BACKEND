...
module.exports = (jwtOptions, passport) => {
    ...
    //START HEROKU
        ...
        // RELATÓRIOS
        .get('/info/vendas/clientes/:mes/:ano', passport.authenticate('jwt', { session: false }), (req,res) => relatorioController.findSellingsByClients(req, res))
        .get('/info/vendas/funcionarios/:mes/:ano', passport.authenticate('jwt', { session: false }), (req,res) => relatorioController.findSellingsByEmployee(req, res))
        .get('/info/vendas/produtos/:type/:mes/:ano', passport.authenticate('jwt', { session: false }), (req,res) => relatorioController.findSellingsByProducts(req, res))
